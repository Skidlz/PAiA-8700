...
BPOINT		jmp PINK 		;BREAKPOINT TRAP.
PINK		ldx #$FF		;INITIALIZE
			txs				;STACK POINTER.
			cld 			;SET HEX MODE.
			stx KEY 		;INITIALIZE KEY.
KEYLOOP		lda KEY			;GET KEY...
...
ADDEM		lda RANDOM,y	;GET THE RANDOM # FROM LOCATION Y.
			...
			ldx #VOXNUM		;GET # OF VOICES.
SCALOOP		ldy TOTAL-1,x	;GET PINK # FOR VOICE #X.
...
PLAY		sta NOTESTAT	;STORE GATE & GLIDE STATUS.
			lda #TEMPO		;INITIALIZE
			sta COUNTEMP	;TEMPO COUNTER.
TEMPLOOP	ldx #VOXNUM		;GET # OF VOICES.
UPDATE		lda OLD-1,x		;GET NOTE TO BE PLAYED.(OLD NOTE) VOICE
