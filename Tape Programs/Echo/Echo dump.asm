...
;
		...
		sta	<lo NTBL,y	;PLACE TO OUTPUT CHANNEL
...
LP2		sta	<lo NTBL,y	;ZERO EACHO OUTPUT CHANNEL
...
PRST	db	$01, $07, $01, $01	;OUTS, ECCO, EDLY, OFST
		db	$01, $07, $01, $08	;"
		db	$01, $03, $02, $08	;"
		db	$01, $03, $02, $10	;"
		
;MUS1 LAST NOTE BUFFER LAST: 0AA-0B9
LAST	db	$00, $00, $FF, $FF, $00, $00, $FF, $FF
		db	$00, $00, $FF, $FF, $00, $00, $FF, $FF

TEMP	db	$01	;INITIAL PRE-SET
ECCO	db	$03	;NUMBER OF ECHO CHANNELS
EDLY	db	$02	;TIMER VALUE
OFST	db	$04
EPNT	db	$00	;ECHO BUFFER POINTER

CLCK	db	$00	;MUS1 CLOCK
		
;MUS1 TRANSPOSE BUFFER TTBL: 0C0-0CF
TTBL	db	$FF, $FF, $00, $00, $FF, $FF, $00, $00
		db	$FF, $FF, $00, $00, $FF, $FC, $00, $00

;MUS1 OUTPUT BUFFER NTBL: 0D0-0DF
NTBL	db	$FF, $FF, $00, $00, $FF, $FF, $00, $00
		db	$FF, $FF, $00, $00,	$FF, $FF, $00
CHN1	db	$00		;CHANNEL 1 NOTE (last byte of NTBL)

;MUS1 INPUT BUFFER KTBL: 0E0-0E7
KTBL	db	$FF, $FF, $00, $00, $FF, $FF, $00, $00
		
CTRL	db	$40	;MUS1 CONTROL TRANSIENT/DYNAMIC MODE
ODLY	db	$20	;MUS1
OUTS	db	$01	;MUS1 # OF OUT CHANS
OUTT	db	$00
CNTR	db	$FF	;TIMER
	end
