...
CLRN	lda	<lo NTBL,y	;GET THE CURRENT OUTPUT NOTE
		and	#$BF		;CLEAR THE TRIGGER FLAG
BOUT	sta	<lo NTBL,y	;AND REPLACE IN OUTPUT BUFFER
		rts				;RETURN
...
CWRD	db	$06
CLCK	db	$27
TTBL	db	$00, $00, $00, $00, $00, $00, $00, $00
		db	$00, $00, $00, $00, $00, $00, $00, $00
NTBL	db	$00, $00, $00, $00, $00, $00, $00, $00
...
;
		...
		beq	RTN			;YES, BRANCH. DON'T WRITE ZERO AS FIRST COMMAt©
